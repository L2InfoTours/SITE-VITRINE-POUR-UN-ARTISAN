 ...
 */
class getTypeChantierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeChantierRepository' shared autowired service.
     *
     * @return \App\Repository\TypeChantierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeChantierRepository.php';

        return $container->privates['App\\Repository\\TypeChantierRepository'] = new \App\Repository\TypeChantierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
