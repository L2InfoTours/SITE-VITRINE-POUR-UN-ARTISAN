 ...
 */
class getContractuelHistoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContractuelHistoRepository' shared autowired service.
     *
     * @return \App\Repository\ContractuelHistoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContractuelHistoRepository.php';

        return $container->privates['App\\Repository\\ContractuelHistoRepository'] = new \App\Repository\ContractuelHistoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
